...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { fetch_date: @rent.fetch_date, listing_id: @rent.listing_id, price: @rent.price }
    end
  ...
  test "should update rent" do
    patch :update, id: @rent, rent: { fetch_date: @rent.fetch_date, listing_id: @rent.listing_id, price: @rent.price }
    assert_redirected_to rent_path(assigns(:rent))
  end
